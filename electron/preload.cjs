...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getComponentThumbnail: request => ipcRenderer.invoke('component-preview:thumbnail', request),
  cancelComponentPreview: requestId => ipcRenderer.invoke('component-preview:cancel', { requestId }),
  componentPreviewPlayback: request => ipcRenderer.invoke('component-preview:playback', request),
  onComponentPreviewReleased: callback => { const listener = (_event, payload) => callback(payload); ipcRenderer.on('component-preview:released', listener); return () => ipcRenderer.removeListener('component-preview:released', listener); },
  cancelComponentPreview: requestId => ipcRenderer.invoke('component-preview:cancel', { requestId }),
  componentPreviewPlayback: request => ipcRenderer.invoke('component-preview:playback', request),
  onComponentPreviewReleased: callback => { const listener = (_event, payload) => callback(payload); ipcRenderer.on('component-preview:released', listener); return () => ipcRenderer.removeListener('component-preview:released', listener); },
