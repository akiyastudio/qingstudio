...
| `declarative-settings` | 带工具页面的声明式设置；[附纯设置页声明方式](declarative-settings/README.md) | `component.settings` |
...
- [开发教程](../docs/PLUGIN_DEVELOPMENT.md)
- [Host API](../docs/PLUGIN_HOST_API.md)
- [开发注册](../docs/COMPONENT_DEVELOPMENT.md)
- [服务协议](../docs/COMPONENT_SERVICE_PROTOCOL_V1.md)
